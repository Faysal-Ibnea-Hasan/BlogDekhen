<header class="bg-white">
    <nav class="mx-auto flex max-w-full items-center justify-between p-6 lg:px-8 border rounded-lg" aria-label="Global">
        <div class="flex lg:flex-1">
            <a href="{{route('blog')}}" class="-m-1.5 p-1.5">
                <span class="text-sm font-semibold leading-6 text-gray-900">BlogDekhen</span>
